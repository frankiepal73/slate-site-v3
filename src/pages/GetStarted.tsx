...
import { Bot, Building2, Users2, MessageSquare, Calendar, ArrowRight, ArrowLeft, Check, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-900 pt-32 pb-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Form */}
        <div className={`bg-white/5 backdrop-blur-xl rounded-2xl p-8 mb-8 relative ${
          currentStep === steps.length - 1 ? 'h-[700px]' : 'min-h-[500px]'
        }`}>
          {steps.map((step, index) => (
            <div
              key={index}
